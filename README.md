...
![Vert.x](https://img.shields.io/badge/Vert.x-782DF0?style=for-the-badge&logo=vert.x&logoColor=white)
...
---
## About
- Java / Spring 기반 백엔드 및 시스템 아키텍처 설계
- Python / FastAPI 기반 백엔드 및 시스템 아키텍처 설계  
- LLM · RAG · Multi-Agent 시스템 설계 및 구현
- 메시징, 이벤트 기반 아키텍처, 분산 시스템 개발 경험  
- 백엔드부터 프론트엔드까지 풀스택 구현  
- 성능과 유지보수성을 고려한 설계 지향
